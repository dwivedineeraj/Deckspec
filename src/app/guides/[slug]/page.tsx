...
const guideContent: Record<string, { title: string; content: string[] }> = {
  // Sources: https://www.trex.com/products/decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/products, https://www.moistureshield.com/products/
  ...
  // Sources: https://www.trex.com/products/decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/products, https://www.deckorators.com/
  ...
  // Sources: https://www.trex.com/customer-support/trex-owners/warranty/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/pages/warranty, https://www.moistureshield.com/support/warranty/
  ...
  // Sources: https://www.trex.com/products/decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/collections/composite-decking, https://www.moistureshield.com/products/, https://www.deckorators.com/
  "composite-decking-cost-guide": {
    title: "Composite Decking Cost Guide: What to Expect per Square Foot",
    content: [
      "Understanding the true cost of composite decking helps you budget effectively for your project. Material costs vary significantly by brand, product line, and region.",
      "## Material Costs by Tier",
      "Below are estimated material-only costs per square foot based on manufacturer data. These are board prices only and don't include substructure, fasteners, railings, or installation.",
      ...
      "- Deckorators Vista: $4.00/sq ft",
      "- TimberTech Prime+: $4.00/sq ft",
      "- Trex Select: $4.20/sq ft",
      "- TimberTech Premier+: $4.20/sq ft",
      "- MoistureShield Meridian: $4.50/sq ft",
      "- TimberTech Terrain+: $4.50/sq ft",
      "- Deckorators Discover: $4.80/sq ft",
      "- Fiberon Promenade: $4.80/sq ft",
      "- Deckorators Vault: $5.00/sq ft",
      "- MoistureShield Vision: $5.00/sq ft",
      "- Fiberon ArmorGuard: $5.20/sq ft",
      "- Fiberon Sanctuary: $5.50/sq ft",
      "**Premium Tier ($5.50-$9.00/sq ft):**",
      "- Trex Transcend: $5.80/sq ft",
      "- Deckorators Voyage: $5.50/sq ft",
      "- TimberTech Reserve: $5.80/sq ft",
      ...
      "- Azek Harvest+: $8.00/sq ft",
      "- Trex Signature: $8.50/sq ft",
      "- Azek Landmark: $8.50/sq ft",
  ...
  // Sources: https://www.trex.com/products/decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/collections/composite-decking, https://www.trex.com/why-trex/deck-material-competitor-comparison/
  "trex-vs-timbertech-vs-fiberon": {
    ...
    content: [
      ...
      "Trex is the world's largest wood-alternative decking manufacturer, using up to 95% recycled materials. Their lineup spans six product lines from entry-level to luxury. **Trex Enhance** ($3.20/sq ft) is the best-selling entry composite with 12 colors and a 25-year warranty. **Trex Select** ($4.20/sq ft) offers a solid core at a mid price with 5 colors and 35-year warranty. **Trex Transcend** ($5.80/sq ft) delivers premium deep wood-grain with 12 colors and excellent scratch resistance. **Trex Transcend Lineage** ($6.50/sq ft) adds heat-mitigating SunComfortable technology with 10 colors and 50-year warranty. **Trex Signature** ($8.50/sq ft) is the luxury line with photorealistic woodgrain in 2 colors. **Trex Refuge** ($7.00/sq ft) is Trex's PVC line for fire-prone areas.",
      "**Best for:** Eco-conscious buyers, largest color selection across all lines, and strong brand recognition for resale value.",
      "## TimberTech: Premium Aesthetics",
      "TimberTech (owned by Azek Building Products) offers both capped composite and premium PVC decking. Their standout feature is unmatched wood-grain realism. **TimberTech Terrain** ($3.80/sq ft) and **Terrain+** ($4.50/sq ft) are entry composites with four-sided capping. **TimberTech Legacy** ($6.50/sq ft) has an artisanal hand-scraped finish. **TimberTech Reserve** ($5.80/sq ft) offers a reclaimed-wood look. **Azek Harvest** ($7.50/sq ft) is entry PVC with 6 colors. **Azek Harvest+** ($8.00/sq ft) adds subtle cathedral grain. **Azek Landmark** ($8.50/sq ft) features crosscut cathedral grain with 6 colors. **Azek Vintage** ($9.00/sq ft) is the flagship PVC with wire-brushed exotic hardwood finish in 8 colors, Cool Touch Technology, and Class A fire rating.",
      ...
      "Fiberon offers competitive pricing with 94% recycled content across their lines. **Fiberon Concordia** ($2.80/sq ft) is the cheapest capped composite available with 5 colors and 25-year warranty. **Fiberon Good Life** ($3.20/sq ft) offers a 30-year warranty with multi-tonal colors in 6 options. **Fiberon Promenade** ($4.80/sq ft) is mid-range solid-core with 6 colors and 35-year warranty. **Fiberon ArmorGuard** ($5.20/sq ft) adds enhanced scratch resistance in 8 colors. **Fiberon Sanctuary** ($5.50/sq ft) offers premium multi-tonal colors in 5 options. **Fiberon Paramount** ($7.50/sq ft) is premium capped PVC with a Lifetime structural warranty and 50-year fade/stain coverage.",
      "**Best for:** Budget-conscious buyers, highest recycled content per board, and projects where every dollar counts.",
  ...
  "best-budget-decking-2026": {
    ...
    content: [
      ...
      "**Fiberon Concordia** ($2.80/sq ft) is the cheapest capped composite on the market. It uses a scalloped profile to reduce weight and cost while maintaining a capped layer. Available in 5 colors with a 25-year warranty. Best for large decks where material volume drives up cost.",
      ...
      "**Trex Enhance** ($3.20/sq ft) is the most popular budget decking in America with 12 colors across Basics and Naturals sub-lines, including multi-tonal options that look more expensive. 25-year warranty. Widely available at Home Depot and Lowe's.",
      ...
      "**TimberTech Premier** ($3.20/sq ft) features a painted-wood look in 5 earthy colors that stand out from typical brown and gray offerings. Scalloped profile keeps weight and cost down.",
      "## Hidden Budget Considerations",
      "Hidden fasteners add $0.50–$1.00/sq ft — budget builds often use face screws with color-matched plugs. Framing (pressure-treated joists) runs $2–$4/sq ft regardless of deck board choice. Professional installation adds $15–$30/sq ft total. DIY can save 40–60% on labor.",
      "## The Bottom Line",
  ...
  // Sources: https://www.trex.com/academy/, https://www.timbertech.com/resources/, https://www.fiberondecking.com/pages/installation-instructions
  ...
  // Sources: https://www.trex.com/customer-support/trex-owners/care-and-cleaning/, https://www.fiberondecking.com/pages/deck-maintenance-and-care, https://www.timbertech.com/resources/care-cleaning/
  "decking-maintenance-guide": {
    ...
    content: [
      ...
      "Sweep away debris. Rinse with a garden hose. Use mild soap and a soft-bristle brush for stuck-on dirt. Rinse thoroughly and let air dry. For PVC decking (Azek, Fiberon Paramount), simple soap and water is usually sufficient — the smooth surface resists dirt buildup.",
      "## Deep Cleaning (Twice a Year)",
      "In spring, clean winter's accumulation of salt and grime. In fall, remove leaves and pollen. Use manufacturer-recommended cleaners or oxygen bleach. Apply with a pump sprayer, let sit 5–10 minutes, scrub gently with a soft brush, and rinse. Avoid bleach-based cleaners on capped composites — they can dull the cap layer over time.",
      "## Pressure Washer Warning",
      "Use extreme caution. Stay at least 12\" from the board surface. Use a 40° or 60° nozzle. Keep pressure under 1,500 PSI. Never use a turbo nozzle — it can permanently damage the cap layer and void your warranty. For PVC decking, lower pressure (under 1,200 PSI) is recommended.",
      "## Stain Removal Guide",
      "Food and drink: warm water and mild soap. Grease and oil: degreaser or dish soap. Wine and coffee: oxygen bleach solution. Rust: oxalic acid cleaner. Mold and mildew: 50/50 vinegar-water solution. Never use acetone, MEK, or paint thinners on composite decking — they will dissolve the cap layer.",
      "## Scratch Prevention",
      "Use felt pads under furniture legs. Lift chairs and grills — don't drag them. Keep pet nails trimmed. Trex Signature and Azek Vintage have the best scratch resistance. Minor scratches often fade as UV exposure blends the cap layer over time.",
      "## Seasonal Tips",
      "Winter: Use a plastic shovel for snow. Avoid ice melt with calcium chloride (damages cap). Rinse salt residue after thaw. Summer: Dark colors absorb heat — consider heat-mitigating products like Trex Transcend Lineage (SunComfortable) or Azek PVC (Cool Touch Technology) for hot climates.",
      "Compare low-maintenance products on our [comparison page](/compare).",
    ],
  },
  // Sources: https://www.fiberondecking.com/pages/wood-vs-composite-decking, https://www.trex.com/why-trex/deck-material-competitor-comparison/trex-vs-wood/
  ...
  // Sources: https://www.trex.com/deck-ideas/colors/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/pages/decking-colors
  ...
  // Sources: https://www.trex.com/products/decking/transcend/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/products/paramount-decking
  ...
  // Sources: https://www.trex.com/why-trex/trex-heat-resistant-decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/products/paramount-decking
  ...
  // Sources: https://www.trex.com/why-trex/fire-resistant-decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/pages/fire-resistant-decking
  ...
  // Sources: https://www.trex.com/products/fasteners-tools/, https://www.timbertech.com/products/fasteners/, https://www.fiberondecking.com/collections/deck-fasteners
  ...
  // Sources: https://www.trex.com/products/decking/, https://www.fiberondecking.com/collections/composite-decking, https://www.fiberondecking.com/pages/fiberon-vs-the-competition
  "fiberon-vs-trex": {
  ...
  // Sources: General industry knowledge based on seasonal retail patterns for Trex, Fiberon, and TimberTech at Home Depot and Lowe's
  "when-to-buy-decking": {
  ...
  // Sources: https://www.moistureshield.com/products/composite-decking/, https://www.trex.com/products/decking/, https://www.timbertech.com/products/decking/, https://www.fiberondecking.com/products
